...
function getConnection() {
	...
	global $db_GOLFAPI_db_Url, $db_GOLFAPI_db_User, $db_GOLFAPI_db_Pass, $db_GOLFAPI_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_GOLFAPI_db_Url.";dbname=".$db_GOLFAPI_db_DbName, $db_GOLFAPI_db_User, $db_GOLFAPI_db_Pass);
